...
namespace Bit
{
	...
	void ShaderProgramOpenGL::SetUniformMatrix4x4f( const char * p_Location, const Matrix4x4 & p_Matrix )
	{
		int UniformLocation = glGetUniformLocation( m_ProgramID, p_Location );
		glUniformMatrix4fv( UniformLocation, 1, GL_FALSE, (GLfloat*)p_Matrix.m );
	}

	void ShaderProgramOpenGL::SetAttributeLocation( const char * p_Location, const BIT_UINT32 p_Index )
	{
