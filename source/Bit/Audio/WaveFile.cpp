...
namespace Bit
{
	...
	Bool WaveFile::LoadFromStream( std::istream & p_Stream )
	{
		...
		if( fileSize < 44 )
		{
			BitLog::NewEngine(Log::Error) << "Wrong file size" << Log::End;
		...
		{
			BitLog::NewEngine(Log::Error) << "No RIFF header were found." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
		...
		{
			BitLog::NewEngine(Log::Error) << "No WAVE field were found.." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
		...
		{
			BitLog::NewEngine(Log::Error) << "No FMT chunk were found." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
		...
		{
			BitLog::NewEngine(Log::Error) << "No PCM WAVE file." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
		...
		{
			BitLog::NewEngine(Log::Error) << "No data chunk were found." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
		...
		{
			BitLog::NewEngine(Log::Error) << "Error in data size." << Log::End;
			p_Stream.seekg( 0, std::fstream::beg ); // Go back to the begining of the stream
			return false;
		}
