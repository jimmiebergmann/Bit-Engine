...
#ifndef BIT_SYSTEM_SPHERE_HPP
#define BIT_SYSTEM_SPHERE_HPP
...
namespace Bit
{
	...
	public:
		...
		Sphere( const BIT_FLOAT32 p_Radius, const Vector3_f32 p_Position );
		...
		BIT_SINT32 Intersection( Sphere p_Sphere );
