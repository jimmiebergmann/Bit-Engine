...
namespace Bit
{
	...
	public:
		...
		////////////////////////////////////////////////////////////////
		/// \brief Set the hash value from another hash object
		///
		////////////////////////////////////////////////////////////////
		void Set(const Hash & p_Hash);
		...
		////////////////////////////////////////////////////////////////
		/// \brief Get a byte from the hash value.
		///
		/// It's much faster to use the GetRaw function
		/// if you want all the hash bytes.
		///
		/// \see GetRaw
		///
		////////////////////////////////////////////////////////////////
		Uint8 GetByte( const SizeType p_Index ) const;
