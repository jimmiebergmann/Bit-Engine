...
namespace Bit
{
	...
	namespace Json
	{
		...
		private:
			...
			///
			////////////////////////////////////////////////////////////////
			Bool ReadArray( Value & p_Value, const std::string & p_Input, SizeType & p_Position ) const;
			...
			///
			////////////////////////////////////////////////////////////////
			Bool ReadNumber( Value & p_Value, const std::string & p_Input, SizeType & p_Position ) const;			
