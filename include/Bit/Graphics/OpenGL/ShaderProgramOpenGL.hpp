...
namespace Bit
{
	...
	public:
		...
		virtual void SetUniformMatrix4x4f( const char * p_Location, const Matrix4x4 & p_Matrix );
		virtual void SetAttributeLocation( const char * p_Location, const BIT_UINT32 p_Index );
